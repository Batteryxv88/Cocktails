const coctailsArr = [
  {
    ...
    description: "Бокал для подачи наполнить кубиками льда. Влить биттер. Перемешать лед, добавить остальные ингредиенты и дольку апельсина, снова перемешать и украсить апельсиновой цедрой. «Негрони» нужно смешивать и выпивать немедленно, чтобы лед не начал таять и разбавлять вкус коктейля.",
    ingredients: [{
      name: "джин",
      vol: 30,
      measure: "мл"
...

  {
    ...
    class: "strong-alcohol",
    description: "Взять бокал и наполнить его льдом доверху. Налить кофейный ликер, налить водку. Налить жирные сливки, перемешать и подавать.",
    ingredients: [{
      name: "жирные сливки",
      vol: 20,
      measure: "мл"
...

  {
    ...
    class: "low_alk",
    description: "Подготовить все ингредиенты. В бокал со льдом влить просекко, апероль и газированную воду. Перемешать барной ложкой. В бокал можно положить и дольку апельсина. Готово к подаче!",
    ingredients: [{
      name: "просекко",
      vol: 100,
      measure: "мл"
...

  {
    ...
    class: "low_alk",
    description: "В высокий бокал положите нарезанный дольками лайм, веточки мяты и сахар. Толкушкой немного раздавите все, чтобы лайм и мята пустили сок. Смешайте оба рома и влейте в бокал. Затем добавьте немного Спрайта и немного шампанского.",
    ingredients: [{
      name: "свежая мята",
      vol: 6,
      measure: "стеблей"
...

  {
    ...
    class: "strong-alcohol",
    description: "Налить в шейкер нежирные сливки, мятный ликер зеленый и какао ликер светлый. Затем наполнить шейкер кубиками льда и взбить. Перелить через стрейнер в охлажденный коктейльный бокал и украсить литиками мяты",
    ingredients: [{
...

  {
    ...
    class: "strong-alcohol",
    description: "Налить в стакан для смешивания лимонный сок, ликер мараскино, фиалковый ликер и джин. Наполнить стакан кубиками льда и аккуратно размешать коктейльной ложкой. Перелить через стрейнер в охлажденный коктейльный бокал, украсить коктейльной вишней",
    ingredients: [{
      name: "сухой джин",
      vol: 50,
      measure: "мл"
...

  {
    ...
    class: "strong-alcohol",
    description: "Довести воду до кипения, добавить чай, сахар и все специи. Влить ром. Довести всё до кипения, сразу же снять и накрыть крышкой. Дать настояться 10-15 мин и сразу же употребить",
    ingredients: [{
      name: "анис (бадьян)",
      vol: 6,
      measure: "шт"
...

  {
    ...
    class: "non_alk",
    description: "Наполните хайбол льдом доверху, на лед налейте карамельный сироп, апельсиновый сок и кофе (чтобы слои не смешивались, это удобнее всего наливать «через» чайную ложку). Украсьте дольками апельсина. Если не хотите портить красоту, то ложкой лучше не размешивать — пейте через трубочку.",
    ingredients: [{
      name: "эспрессо",
      vol: 50,
      measure: "мл"
